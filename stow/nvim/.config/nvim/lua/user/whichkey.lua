...
local mappings = {
  ...
  d = {
    ...
    L = {
      ...
      'List breakpoints in quickfix window',
    },
...
local mapping_alt = {
  ...
  g = {
    ...
    y = {
      "<cmd>lua require('user.vim-gh-line').yank_gh_line(true)<CR>",
      'Yank GH remote URL (commit) to clipboard',
    },
    Y = {
      "<cmd>lua require('user.vim-gh-line').yank_gh_line(false)<CR>",
      'Yank GH remote URL (branch) to clipboard',
    },
    o = {
